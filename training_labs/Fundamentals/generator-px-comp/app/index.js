...
//        }
    ...
    this.prompt(prompts, function (props) {
        ...
        this.repoUrl = "https://github.sw.ge.com/change-this-in-package.json-please.git";
...
//        }
        ...
        if (this.mixins) {
            try {
                ...
                this.mixins.forEach(function(mixin) {
                    ...
                    var mixinRepoUrl = mixinPkg.repository ? mixinPkg.repository.url : "https://github.sw.ge.com/change-this-in-bower.json-please.git";
        ...
        if (this.extending) {
            try {
                ...
                this.extRepo = this.extPkg.repository ? this.extPkg.repository.url : "https://github.sw.ge.com/change-this-in-bower.json-please.git";
            }
            catch(e) {
